...
This directory contains source files for the Selkup language morphology
...
In order to compile and use Selkup language morphology and dictionaries,
you need:
...
The Selkup language sources can be acquired using [giella SVN
